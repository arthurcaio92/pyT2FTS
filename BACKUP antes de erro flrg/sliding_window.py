...
def janela_deslizante(data,diff,particoes,ordens,metodo_part):
    ...
    if not erros_especifico['media_1_ordem']:
        erros_especifico['media_1_ordem'] =np.zeros(len(particoes))
        erros_especifico['desvio_1_ordem'] =np.zeros(len(particoes))
        
    if not erros_especifico['media_2_ordem']:
        erros_especifico['media_2_ordem'] =np.zeros(len(particoes))
        erros_especifico['desvio_2_ordem'] =np.zeros(len(particoes))

    if not erros_especifico['media_3_ordem']:
        erros_especifico['media_3_ordem'] =np.zeros(len(particoes))
        erros_especifico['desvio_3_ordem'] =np.zeros(len(particoes))
