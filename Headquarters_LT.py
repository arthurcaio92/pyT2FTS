...
def T2FTS(data,method_part,mf_type,partition_parameters,order,diff,training):
    ...
    return error_list,number_of_sets,FLR,FLRG,modelo



def prever_LT(data,method_part,mf_type,partition_parameters,order,diff,training):
    ...
    PROXIMA_PREVISAO = forecast_result[-1]   
